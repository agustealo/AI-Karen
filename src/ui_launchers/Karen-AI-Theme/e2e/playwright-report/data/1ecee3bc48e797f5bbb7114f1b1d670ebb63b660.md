...
- Name: test_gemini_live_response.spec.ts >> Gemini Live Response Tests >> Response metadata shows live_model source
- Location: test_gemini_live_response.spec.ts:198:7
...
Call log:
  - navigating to "http://localhost:8010/", waiting until "load"
