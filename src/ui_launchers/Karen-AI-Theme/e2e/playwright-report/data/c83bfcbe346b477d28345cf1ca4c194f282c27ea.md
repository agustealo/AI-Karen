...
- Name: test_gemini_live_response.spec.ts >> Gemini Live Response Tests >> Gemini provider returns live response with correct metadata
- Location: test_gemini_live_response.spec.ts:62:7
